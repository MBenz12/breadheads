export const SOLANA_RPC_URL = "https://patient-empty-rain.solana-mainnet.quiknode.pro/dfba1e28dfc6728a18eef1b0e51e5f4c2db4cc05/";
export const VAULT_NAME = "breadheads";
export const COLLECTION_TOTAL_COUNT = 2979;
export const NFT_CREATOR = "7kEzkXbtqJ3yLc86dZPVCAzuiJU8eNeE43jWhHhwiphM";
